...
!BOP
! !ROUTINE: ac72_getFCOVERpred
! \label{ac72_getFCOVERpred}
!
! !REVISION HISTORY:
! 22 Dec 2017: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine ac72_getFCOVERpred(n, k,obs_pred)
! !USES:
  use ESMF
...
!EOP
  ...
  real                   :: AC72CCiprev(LIS_rc%npatch(n,LIS_rc%lsm_index))
...
end subroutine ac72_getFCOVERpred