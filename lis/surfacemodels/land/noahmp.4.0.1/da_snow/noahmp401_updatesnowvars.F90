...
!BOP
! !ROUTINE: noahmp401_updatesnowvars
! \label{noahmp401_updatesnowvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_updatesnowvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
end subroutine noahmp401_updatesnowvars
